...
#need to generate figures about results
...
r = 2
combodict = {}
for combo in combinations(indexset,2):
    combodict[combo] = 0
...
totalcount = (hoppedcount + matchedcountR1 + matchedcountR2 + unknowncount)
pcthopped = (hoppedcount / totalcount) * 100
pctmatched = ((matchedcountR1 + matchedcountR2) / totalcount) * 100
pctunknown = (unknowncount / totalcount) * 100
print(f'{hoppedcount=}')
print(f'{matchedcountR1=}')
print(f'{matchedcountR2=}')
